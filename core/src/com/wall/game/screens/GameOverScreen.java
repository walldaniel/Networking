...
public class GameOverScreen implements Screen {
	...
	public GameOverScreen(AsteroidGame game, int score) {
		...
		// Make sure user doesn't just instantly go back to game
		startTime = System.currentTimeMillis();
	}

	public void update(float dt) {
		// Restarts the game once the player releases a mouse button, and the gameover screen has displayed for 1 second
